...
ActiveRecord::Schema.define(version: 2021_01_15_165430) do
  ...
  create_table "doctors", force: :cascade do |t|
    ...
    t.string "specialty"
    t.string "university"
    t.bigint "hospitial_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["hospitial_id"], name: "index_doctors_on_hospitial_id"
  end

  create_table "hospitials", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "doctors", "hospitials"
end
